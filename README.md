...
## 센서 데이터 처리용 미들웨어 제작
1. IoT 표준기술 (oneM2M) - 온실의 센싱 데이터 처리 및 전송을 위한 oneM2M Gateway Platform- 온실의 데이터 수집 및 관리를 위한 oneM2M Server Platform<br/>
...
3. 온실 통합제어기 간 RS485기반 Modbus 인터페이스 제작<br/>
...
5. 유리온실 통합 관제시스템 UI 제작(WEB/APP)<br/>
