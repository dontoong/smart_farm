...
" margin:9px;}")
        ...
        self.label_12.setGeometry(QtCore.QRect(40, 185, 200, 75))
        font = QtGui.QFont()
        font.setFamily("휴먼편지체")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_3.setGeometry(QtCore.QRect(40, 260, 200, 75))
        font = QtGui.QFont()
        font.setFamily("양재참숯체B")
        font.setPointSize(20)
        ...
        self.label_8.setGeometry(QtCore.QRect(470, 30, 70, 70))
...
"color:#aaffff;")
        ...
        # self.pushButton_7.clicked.connect(Dialog.btn_main_to_ph)
        # self.pushButton_8.clicked.connect(Dialog.btn_main_to_co2)
